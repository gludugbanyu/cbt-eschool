...
<li class="sidebar-item submenu"><a class="sidebar-link" href="soal.php"><i class="align-middle fas fa-book"></i> Bank Soal</a></li>
<li class="sidebar-item submenu"><a class="sidebar-link" href="upload-gambar.php"><i class="align-middle fas fa-upload"></i> Upload Gambar</a></li>
<li class="sidebar-item submenu"><a class="sidebar-link" href="kartu_siswa.php"><i class="align-middle fa fa-id-card"></i> Cetak Kartu Ujian</a></li>
<li class="sidebar-item submenu"><a class="sidebar-link" href="daftar_hadir.php"><i class="align-middle fa fa-print"></i> Cetak Daftar Hadir</a></li>
<li class="sidebar-item submenu"><a class="sidebar-link" href="berita_acara.php"><i class="align-middle fa fa-print"></i> Cetak Berita Acara</a></li>
</ul>
</li>
...
<?php endif; ?>
<?php if($role=='admin'): ?>
<li class="sidebar-item <?= ($currentPage == 'manajemen_user.php') ? 'active' : '' ?> <?= ($currentPage == 'edit_user.php') ? 'active' : '' ?> <?= ($currentPage == 'tambah_user.php') ? 'active' : '' ?>">
...
<li class="sidebar-item submenu"><a class="sidebar-link" href="backup.php"><i class="align-middle fa fa-database"></i> Backup Database</a></li>
<li class="sidebar-item submenu"><a class="sidebar-link" href="backup_gbr.php"><i class="align-middle fa fa-download"></i> Backup Gambar Soal</a></li>
<li class="sidebar-item submenu"><a class="sidebar-link" href="reset_database.php"><i class="align-middle fa-regular fa-floppy-disk"></i> Reset Database</a></li>
</ul>
</li>
